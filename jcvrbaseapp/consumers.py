...
from basesite.settings import MSG_TYPE_LEAVE, MSG_TYPE_ENTER, NOTIFY_USERS_ON_ENTER_OR_LEAVE_ROOMS
...
def ws_receive(message):
    ...
    Channel("jcvrbaseapp.receive").send(payload)
